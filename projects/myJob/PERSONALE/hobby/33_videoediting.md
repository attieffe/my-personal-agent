...
━━━━━━━━━━━━━━━━━━━━━━━ 
⚠️ Usage Notice ▪️ 1 account can be used on max 2 devices only. ▪️ Using more devices may cause “Maximum attempts” error. ▪️ If this happens due to misuse, no refund will be provided. ▪️ For PC login, use QR code and scan it via the CapCut mobile app.```
