...
- [ ] **OpenClaw — accesso mail e calendario** — approfondire: accesso in lettura alle mail, ricerca mail, integrazione calendario. Analizzare come lo gestiscono Google (Gmail API, Google Calendar) e Microsoft (Graph API, Outlook) (2026-05-16)
