...
> - Sfere: `personale` · `freelance` · `ingenio`
> - Canali freelance: `diretto` · `agenzia`
...
- [ ] Aggiornare OPENCLAW da 2026.6.1 → 2026.6.5
...
- [x] Monitorare bug OpenClaw #85314 e verificare se viene corretto [chiuso 2026-06-10]
...
### freelance
- Clienti diretti → [[FREELANCE/DIRETTI/]]
- Sinapps → [[FREELANCE/SINAPPS/]]
- Get Me Digital → [[FREELANCE/GET_ME_DIGITAL/]]

### ingenio solution
- Archivio → [[INGENIO_SOLUTION/]]
