...
- [x] Ingest JSONL trajectory come fonte primaria per provider/model/token
- [x] Dashboard con grafico orario stacked per provider/modello
...
- [ ] Export/HTML report statico per l'host report
