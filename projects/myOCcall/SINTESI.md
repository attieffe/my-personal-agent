...
Un sistema che permette a AttiBot di entrare in una videochiamata (Google Meet, Zoom, Teams) come partecipante silenzioso, registrare l'audio, trascriverlo automaticamente e produrre un riassunto strutturato da inviare ad Atti via Telegram.
...
1. Manda a AttiBot il link della call
2. AttiBot entra, ascolta e registra
