...
Un sistema che permette a IAcopo di entrare in una videochiamata (Google Meet, Zoom, Teams) come partecipante silenzioso, registrare l'audio, trascriverlo automaticamente e produrre un riassunto strutturato da inviare ad Atti via Telegram.
...
1. Manda a IAcopo il link della call
2. IAcopo entra, ascolta e registra
